...
@Get('teenlancer/gigs')
@UseGuards(JwtAuthGuard)
  findTeenlancerGigs(@CurrentUser() user: UserDocument) {
...
@HttpCode(HttpStatus.CREATED)
  create(
    ...
    return this.gigsService.create(String(user._id), this.normalizeGigDto(body));
}
...
@HttpCode(HttpStatus.OK)
  update(
    ...
    return this.gigsService.update(id, String(user._id), this.normalizeGigDto(body));
}
